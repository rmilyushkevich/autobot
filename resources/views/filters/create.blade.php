                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('filter.save') }}">
                            ...
                            <div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-3">
                                    <input id="price_min" type="text" class="form-control" name="price_min" placeholder="Цена от"/>
                                </div>
                                <div class="col-md-3">
                                    <input id="price_max" type="text" class="form-control" name="price_max" placeholder="Цена до"/>
                                </div>
                                @if ($errors->has('price'))
                                    <span class="help-block">
